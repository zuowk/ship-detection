...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, dilation=1):
        ...
        self.bn1 = nn.BatchNorm2d(bottle_planes, momentum=0.1)
        self.conv2 = nn.Conv2d(bottle_planes, bottle_planes, kernel_size=3,
                               stride=stride, padding=dilation,
                               bias=False, dilation=dilation)
        self.bn2 = nn.BatchNorm2d(bottle_planes, momentum=0.1)
...
def dla46(pretrained=None, **kwargs):  # DLA-X-46-C
...
class DLASeg(nn.Module):
    def __init__(self, base_name, heads, pretrained, down_ratio, final_kernel,
        ...
        self.base = globals()[base_name](pretrained=False)
...
if __name__ == '__main__':
    net = get_pose_net(46, {'hm': 1, 'corner': 4}).cuda()
    # net = dla34()
